...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { name: "Projects", target: "expertise" },
    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
        ...
        <div className="flex items-center">
          <a
            href="#home"
            className={`text-xl md:text-2xl font-black tracking-tight transition-colors duration-500 ${
              isOpen || !isScrolled ? "text-white" : "text-gray-900"
            }`}
          >
            Ganesh Kumar <span className="text-[#ff2a2a]">.</span>
          </a>
        </div>
      ...
      <div
        className={`md:hidden absolute top-full left-0 w-full transition-all duration-500 ease-in-out ${
          isOpen
            ? "max-h-[400px] py-6 opacity-100 bg-[#ff2a2a] shadow-2xl"
