...
import stackImage from "../assets/about/ganesh.jpeg";
    ...
    >
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-16 items-start">
        ...
        >
          ...
          <p className="text-lg font-bold leading-relaxed max-w-3xl text-red-50">
            Hi, my name is{" "}
            <span className="text-black text-xl font-black mx-1 tracking-wide uppercase">
              Ganesh Kumar
            </span>
            , a Software Developer passionate about Artificial Intelligence,
            Machine Learning, and modern web development. I enjoy building
            real-world applications that combine intelligent systems, scalable
            backend services, and modern user experiences.
          </p>
        </div>
      </div>
